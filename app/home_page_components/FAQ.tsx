            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-4">
                  <h3
                    className={`font-baloo text-base sm:text-lg lg:text-xl font-extrabold leading-snug transition-colors duration-200 ${
                      isHovered ? "text-[var(--color-primary)]" : "text-[var(--color-secondary)]"
                    }`}
                  >
                    {faq.question}
                  </h3>
