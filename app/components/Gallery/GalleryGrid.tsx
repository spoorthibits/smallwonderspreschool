...
const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    image: "/individual_kids/galleryimg-8.jpeg",
    themeColor: "#2563eb",
    knobColor: "#2563eb",
    iconBg: "rgba(255,255,255,0.25)",
  ...
  },
  {
    ...
    category: "Classroom",
    title: "Group Study",
    description: "Learning with peers.",
    image: "/classrooms/classroom_learning_4.JPG",
    themeColor: "#f5a623",
    knobColor: "#f5a623",
    iconBg: "rgba(255,255,255,0.25)",
    icon: <BookOpen size={22} color="#fff" />,
  ...
  const filtered =
    activeFilter === "all"
      ? [...galleryItems].sort((a, b) => {
          if (a.category === "Annual Day" && b.category !== "Annual Day") return -1;
          if (a.category !== "Annual Day" && b.category === "Annual Day") return 1;
          return 0;
        })
          ...
          {displayedItems.map((item) => (
            ...
            >
              <Image
                ...
                className={`object-cover object-top transition-transform duration-500 group-hover:scale-105 ${item.imageClassName || ""}`}
              />
