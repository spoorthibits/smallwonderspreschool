...
export default function AboutBanner() {
  return (
    <section className="w-full bg-[#fdf9f3] relative overflow-visible">
      ...
      {/* ── DESKTOP (lg+): flex layout where image dictates height ── */}
      <div className="hidden lg:flex w-full items-stretch">
        
        {/* LEFT CONTENT */}
        <div className="w-1/2 flex items-center justify-end relative">
          <div className="w-full max-w-[600px] px-8 xl:px-12 py-10 relative">
        ...
        {/* RIGHT CONTENT: Image drives the height */}
        <div className="w-1/2 relative flex items-stretch">
          <Image
            src="/real_school/kids_music_activity.png"
            alt="About Banner"
            width={1200}
