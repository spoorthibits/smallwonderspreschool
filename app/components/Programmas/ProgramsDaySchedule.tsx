      ...
      {videoOpen && (
        ...
        >
          ...
          >
            ...
            <video src="/school-day.mp4" controls autoPlay className="w-full aspect-video object-cover object-top" />
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-2 md:mb-10 lg:mb-20">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative cursor-pointer group" onClick={() => setVideoOpen(true)}>
              ...
              >
                <video src="/school-day.mp4" className="w-full h-full object-cover object-top" muted playsInline />
